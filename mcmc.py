...
def onload(
    ...
    def runmcmc(iteration, dvect, classification, qq, correction_distance_matrix):
        ...
        for i in range(nids):
            switch_hidden(i, hidden0, hiddenf, classification, nloci, maxMOI, recoded0, frequencies_RR, alleles_definitions_RR, qq, dvect, correction_distance_matrix, alleles0, MOI0, MOIf, allelesf, mindistance, alldistance, recodedf, allrecrf, recr0, recrf, recr_repeats0, recr_repeatsf)
